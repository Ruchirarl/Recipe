...
if search_type:
    ...
    if st.button("Find Recipe"):
        if search_type == "By Personality":
            ...
            recipe = get_recipe_by_ingredient(ingredient, 120)  # Default max time 120 min
        elif search_type == "By Nutrients":
            recipe = get_recipe_by_nutrients(nutrient, min_value, max_value, 120)  # Default max time 120 min
